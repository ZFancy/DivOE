...
from models.wrn import WideResNet,WideResNet_normalized
...
if __package__ is None:
    ...
    from utils.tiny_imagenet_loader import customTinyImageNet
...
tiny_imagenet = dset.ImageFolder(root='../data/tiny-imagenet-200/train', transform=
trn.Compose([trn.ToTensor(), trn.ToPILImage(), trn.RandomCrop(32, padding=4),
             trn.RandomHorizontalFlip(), trn.ToTensor()]))
ood_data = customTinyImageNet(tiny_imagenet)
...
# Create model
net = WideResNet_normalized(args.layers, num_classes, args.widen_factor, dropRate=args.droprate)
