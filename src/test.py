...
if args.score == 'Odin':
    ...
    _, right_score, wrong_score = get_ood_scores(test_loader, in_dist=True)
    in_score = lib.get_ood_scores_gradnorm(test_loader, net, ood_num_examples, num_classes, args.T)
else:
...
def get_and_print_results(ood_loader, num_to_avg=args.num_to_avg):
    ...
    for _ in range(num_to_avg):
        if args.score == 'Odin':
            ...
            out_score = lib.get_ood_scores_gradnorm(ood_loader, net, ood_num_examples, num_classes, args.T)
        else:
...
# /////////////// Textures ///////////////
ood_data = dset.ImageFolder(root="../data/dtd/dtd/dtd/images",
...
if 'cifar10_' in args.method_name:
    ood_data = dset.CIFAR10('../data/vision-greg/cifarpy', train=False, transform=trn.ToTensor(), download=True)
else:
    ood_data = dset.CIFAR100('../data/vision-greg/cifarpy', train=False, transform=trn.ToTensor(), download=True)
